<?php
    ...
    (new Articulos)->generarArticulos(20);
...
<html lang="es">
    ...
    <body style="background-color: silver;">
        <h3 class="text-center my-4">Articulos Tienda</h3>
        <div class="container mt-2">
        <a href="carticulo.php" class="btn btn-primary mb-2"><i class="fas fa-plus"></i> Nuevo Articulo</a>
        <a href="../" class="btn btn-primary mb-2"><i class="fas fa-backward"></i> Volver</a>
            <table class="table table-dark table-sm">
                <thead>
                    <tr>
                        <th scope="col" style="text-align:center;">Id Articulo</th>
                        <th scope="col" style="text-align:center;">Nombre</th>
                        <th scope="col" style="text-align:center;">Precio</th>
                        <th scope="col" style="text-align:center;">Categoria Id</th>
                        ...
                        while($fila=$stmt->fetch(PDO::FETCH_OBJ)){
                            echo <<< TXT
                                <tr>
                                    ...
                                    <td style='text-align:center;'>{$fila->categoria_id}</td>
                                    <td>
                                        <form name='s' action='barticulo.php' method='POST' style='text-align:center;'>
